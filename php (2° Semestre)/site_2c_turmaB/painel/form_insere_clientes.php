        ...
        <div class="container-fluid px-4">
            ...
            <form action="insere_clientes.php" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nome" placeholder="ex.: Fulano de Tal" required>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">E-mail</label>
                    <input type="email" class="form-control" name="email" placeholder="ex.: emailcliente@gmail.com" required>
                </div>
                <div class="mb-3">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input type="text" class="form-control" name="telefone" placeholder="ex.: (11) 99999-9999" required>
                </div>
